...
| `responsibleImage` | [This issue](https://github.com/facebook/react-native/issues/11906) fixes a bug in React Native with `<Image>` component inside of `<Text>` components. **latest RN Version is fixed.** | `bool`                 | `false` |
